...
# FSRA Compatible Adapter Function
def vim_small_patch16_224_FSRA(img_size=(256, 256), stride_size=[16, 16], drop_path_rate=0.1, 
                              drop_rate=0.0, attn_drop_rate=0.0, **kwargs):
    """
    VIM model adapter for FSRA compatibility
    """
    # Use the vim_small model with midclstok for compatibility with pretrained weights
